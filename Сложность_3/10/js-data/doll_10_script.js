(() => {
  ...
  const soundBtfullScreenBtn = wrapper.querySelector(".doll_10_FullScreenBtn");
  ...
  function soundChanger() {
    soundOn = !soundOn;
    if (soundOn) {
      soundBtn.src = "Images_1/doll_10_img/onSound.svg";
    } else {
      soundBtn.src = "Images_1/doll_10_img/mute.svg";
    }
  }
