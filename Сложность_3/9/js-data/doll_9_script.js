...
(() => {
    ...
    function winTextSwitcherdoll_9_(feedBack) {
        if (windoll_9_) {
            if (wrapper.querySelector('.doll_9_Well_done').classList.contains('fadedoll_9_')) {

                wrapper.querySelector('.doll_9_Well_done').classList.remove('fadedoll_9_');
                wrapper.querySelector('.doll_9_Well_done').classList.add('onViewdoll_9_');
                feedBackdoll_9_.src = feedBack;
            }
            else if (wrapper.querySelector('.doll_9_Well_done').classList.contains('onViewdoll_9_')) {
                wrapper.querySelector('.doll_9_Well_done').classList.remove('onViewdoll_9_');
                wrapper.querySelector('.doll_9_Well_done').classList.add('fadedoll_9_');
