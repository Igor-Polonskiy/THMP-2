(() => {
    ...
    function showOpeningBox(e) {
        ...
        // openBoxCardBoardBox.style.backgroundImage = 'url(Images_1/doll_3_img/Box_opening_trueSize.png)';
        if (soundOn) {
    ...
    function fadeOpeningBox(e) {
        ...
        // openBoxCardBoardBox.style.backgroundImage = 'url(Images_1/doll_3_img/Box_closed_trueSize.png)';
        if (soundOn) {
    ...
    function openBox(e) {
        ...
        // openBoxCardBoardBox.style.backgroundImage = 'url(Images_1/doll_3_img/Box_opened_trueSize.png)';
        if (soundOn) {
            // start melody opened
            playSound(openSound);
        }
    ...
    resetBtn.addEventListener('click', () => {
        for (let i = 0; i < elemsdoll_3_.length; i++) {
            elemsdoll_3_[i].classList.add("hide");
            elemsdoll_3_[i].style.position = 'relative ';
            elemsdoll_3_[i].style.top = '0px';
            elemsdoll_3_[i].style.left = '0px';
            insideBox.append(elemsdoll_3_[i]);
            // itemCounter();
        }
    ...
    function mouseDown(event) {
        ...
        draggingItem.style.cursor = "url(Images_1/doll_3_img/cursor.png), auto";
        ...
        draggingItem.onpointerup = function (e) {
            ...
            if (elemBelow.classList.contains('doll_3_Main')) {
    ...
    function winTextSwitcher() {
        ...
        if (!well_done.classList.contains('onViewdoll_3')) {
            // well_done.classList.remove('hide');
            well_done.classList.add('onViewdoll_3_');
            soundOn && playSound(winSound);

        } else if (well_done.classList.contains('onViewdoll_3')) {
